...
object FactoryModel extends ModelNameMap[FactoryModel] {
 ...
 _models += (
  ...
  "brickworks" -> new FactoryModel("Brickworks", 400, List(),
  ...
  "glass_factory" -> new FactoryModel("Glass Factory", 800, List(),
  ...
  "quarry" -> new FactoryModel("Quarry", 444, List(),
  ...
  "stockyard" -> new FactoryModel("Stockyard", 1200, List(),
    List(new ProductionCycle(HashMap(Cattle -> 4), HashMap(Meat -> 6), 0.7),
        new ProductionCycle(HashMap(Cattle -> 4), HashMap(Sheep -> 6), 0.7),
        new ProductionCycle(HashMap(Cattle -> 4), HashMap(Pigs -> 6), 0.7))),
  ...
  "vegetables" -> new FactoryModel("Vegetable Farm", 1100, List(),
  ...
  "wiremill" -> new FactoryModel("Wire Mill", 1280, List(),
